...
| Category | Domain |
| --- | --- |
| `Landing Page` | Hero, value props, feature showcase, CTAs |
| `Demo Experience` | Demo credentials, guided tour, onboarding |
| `Content & Copy` | Marketing text, feature descriptions, blog |
| `SEO & Analytics` | Meta tags, structured data, tracking |
| `Core Features` | Primary functionality, core workflows |
| `Security` | Authentication, encryption, trust signals |
| `Performance` | Optimization, caching, loading speed |
| `Infrastructure` | CI/CD, deployment, hosting, Docker |
